...
(1, 'SAMSUNG Galaxy S23 Ultra', 's23.jpg', '476999.00', 'S Series has a legacy of pushing the boundaries of what a smartphone can do. And with Galaxy S23 Ultra, we’re raising that bar again. Galaxy S23 Ultra is more than the next big step in mobile tech. With the highest camera resolution on a phone.', NULL),
(2, 'iPhone 14 Plus - 128GB - Blue', 'i14p.jpg', '449999.00', 'The iPhone 14 Plus is an excellent choice if you\'re looking for a big-screen experience. The iPhone 14 Plus delivers an immersive 6.7-inch display and extra-long battery life in a refreshingly lightweight design. While the cameras are stellar, the lack of optical zoom and a 120Hz display are bummers when compared to similar flagships at this price.', NULL);
